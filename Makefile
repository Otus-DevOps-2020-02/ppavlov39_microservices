...
push_all: push_ui push_post push_comment push_bb_exporter push_prometheus
build_all: build_ui build_post build_comment build_prometheus build_bb_exporter
