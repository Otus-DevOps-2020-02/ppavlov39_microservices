...
<b>В этой работе сделано:</b>
<ul>
  <li>Разобрались в типах сервисов;</li>
  <li>Убедились в важности нормального функционирования сервиса DNS;</li>
  <li>Опробовали в работе сервис типа LoadBalancer от Google;</li>
  <li>Настроили Ingress контроллер, предоставляемый Google, на прием трафика для нашего приложения и терминацию SSL соединения, а также L7 маршрутизацию;</li>
  <li>Также настроили использование NetworkPolicy, для разграничения трафика между фронтом и беком;</li>
  <li>Опробовали различные типы PersistentVolume и настроили динамическое выделение PV для нашей базы Mongo.</li>
</ul>
<b>Задание со *</b><br>
<ul>
  <li>Было описано создание объекта типа secret в виде манифеста, в файле tls-secret.yml</li>
</ul>

<h1>Kubernetes-4</h1>
<b>В этой работе сделано:</b>
<ul>
  <li>Установлен и сконфигурирован Helm, опробованы варианты его использования второй версии как с утановленными Tiller-ом, так и без него, а также третья версия;</li>
  <li>Подготовленны чарты для деплоя нашего приложения в кластер кубера с применение Helm-а;</li>
  <li>Развернут Gitlab в кластере кубера;</li>
  <li>Настроен CI на базе Gitlab, разворачивающий динамические окружения и окружения для теста и прода;</li>
  <li>Файлы gitlab-ci.yml переписаны без использования auto-devops;</li>
</ul>

<h1>Kubernetes-5</h1>
<b>В этой работе сделано:</b>
<ul>
  <li>Развернут Prometheus в кластере Kubernetes;</li>
  <li>Произведена его настройка для исользования возможностей service discovery, для автоматического обнаружения сущностей;</li>
  <li>Также, в кластере kubernetes развернута grafana;</li>
  <li>Отредактированы ранее созданные шаблоны дашбордов для возможности фильтрации информации на графиках по окружениям;</li>
  <li>Развернут стек EFK для мониторинга;</li>
</ul>
